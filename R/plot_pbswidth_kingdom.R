#' @title Plot the median PBS widths for kingdoms of life
#' @description Visualize the correlation between LTR transposon age
#' (measured in LTR similarity) and the median PBS width of the corresponding LTR retrotransposon.
