...
test_installation_usearch <- function() {
    ...
    tryCatch({
        ...
        stop(
            "It seems like you don't have USEARCH installed locally on your machine
            or the PATH variable to the USEARCH program is not set correctly.",
            "Please consult the Installation vignette or https://github.com/genometools/genometools 
            for details on how to install USEARCH.",
            call. = FALSE
        ))
