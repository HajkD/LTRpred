...
read.ltrpred <- function(data.sheet){
    ...
    pred <- readr::read_delim(data.sheet, col_types = readr::cols(
        ...
        "TE_CG_abs" = readr::col_integer(),
        "TE_CG_rel" = readr::col_double(),
        "TE_CHG_abs" = readr::col_integer(),
        "TE_CHG_rel" = readr::col_double(),
        "TE_CHH_abs" = readr::col_integer(),
        "TE_CHH_rel" = readr::col_double(),
        "TE_CCG_abs" = readr::col_integer(),
        "TE_CCG_rel" = readr::col_double(),
        "TE_N_abs" = readr::col_integer(),
        "CG_3ltr_abs" = readr::col_integer(),
        "CG_3ltr_rel" = readr::col_double(),
        "CHG_3ltr_abs" = readr::col_integer(),
        "CHG_3ltr_rel" = readr::col_double(),
        "CHH_3ltr_abs" = readr::col_integer(),
        "CHH_3ltr_rel" = readr::col_double(),
        "CCG_3ltr_abs" = readr::col_integer(),
        "CCG_3ltr_rel" = readr::col_double(),
        "N_3ltr_abs" = readr::col_integer(),
        "CG_5ltr_abs" = readr::col_integer(),
        "CG_5ltr_rel" = readr::col_double(),
        "CHG_5ltr_abs" = readr::col_integer(),
        "CHG_5ltr_rel" = readr::col_double(),
        "CHH_5ltr_abs" = readr::col_integer(),
        "CHH_5ltr_rel" = readr::col_double(),
        "CCG_5ltr_abs" = readr::col_integer(),
