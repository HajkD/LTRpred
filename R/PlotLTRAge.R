...
#' All elements not fulfilling this similarity threshold are filtered out.
...
PlotLTRAge <- function(LTRpred.tbl, 
    ...
    if (is.null(similarity.bin) & is.null(min.sim)) {
        ...
        res <- ggplot2::ggplot(LTRpred.tbl, ggplot2::aes(x = similarity, fill = similarity), order = FALSE) +
