...
#' by \code{\link[LTRpred]{LTRpred}} and any other variable 
...
plotCN <-
    ...
    # p <- ggplot2::ggplot(data, ggplot2::aes(x = lazyeval::interp(quote(x)), y = lazyeval::interp(quote(y)), color = factor(lazyeval::interp(quote(color))))) +
    #     ggplot2::geom_point() + 
    #     ggplot2::theme_minimal()
    
    p <- ggplot2::ggplot(data, ggplot2::aes_string(x = "cn_3ltr", y = y, color = color.by)) +
            ggplot2::geom_point() +
            ggplot2::theme_minimal() + 
