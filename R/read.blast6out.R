...
#' @param path to blast6out file (\code{*.blast6out} extension).
...
read.blast6out <- function(blast6out.file){
  ...
  colnames(blast6out.df) <- c("query","subject","perc_ident","align_len",
                       "n_mismatch","n_gap_open","start_q","end_q",
                       "start_s","end_s","evalue","bit_score")
