...
#' LTRpred::check_annotation_ltrpred(Ath_path)
...
#' LTRpred::check_annotation_ltrpred(Ath_path, remove_annotation_outliers = TRUE)
#' }
#' @export

check_annotation_ltrpred <- function(annotation_file, remove_annotation_outliers = FALSE) {
