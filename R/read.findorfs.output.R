#' @title Read output of \code{PredictORFs}
...
#' @param findorfs.file fasta file generated by \code{\link{PredictORFs}}.
...
#' ORFPred <- read.findorfs.output(system.file("nt.fa",package = "LTRpred"))
#' 
#' head(ORFPred)
