...
#' @details 
#' The BED file format is defined by: chromosome; start; end; columns.
#' @examples 
...
#' 
#' # generate BED file
#' bed.file <- pred2bed(LTRfile$ltr.retrotransposon)
#' head(bed.file)
#' 
#' # write BED file to hard drive
#' write.table(bed.file,"test.bed", quote = FALSE, col.names = TRUE, row.names = FALSE)
#' @references http://www.ensembl.org/info/website/upload/bed.html
#' @export
pred2bed <- function(LTR.data){
