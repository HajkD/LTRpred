...
Please follow the `dfamscan.pl` installation instructions at http://www.dfam.org/web_download/Tools/README.txt .


Alternatively, users can use the [Bioconda](https://bioconda.github.io/) package management system to install `Dfam`. For this approach, please [install Bioconda](https://conda.io/miniconda.html) and run:
